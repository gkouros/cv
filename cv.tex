...
\addtofrontsidebar{
	...
	\aboutme{I am an aspiring Robotics/AI researcher, experienced in mobile robotics, computer vision, and deep learning. I enjoy working on making robots more versatile, more robust, and more intelligent in the service of society.}
	...
	\begin{figure}\centering
		\smartdiagram[bubble diagram]{
			\textcolor{white}{\textbf{Artificial}}\\
			\textcolor{white}{\textbf{Intelligence}},
			\textcolor{black!90}{Robotics},
%			\textcolor{black!90}{C++},
			\textcolor{black!90}{Deep}\\
			\textcolor{black!90}{Learning},
...
\begin{cvtable}[1.5]
%	\vspace{0.1cm}
	\cvitem{2020 -- Now}{Advanced Master of Artificial Intelligence}{KU Leuven (Belgium)}
		{\small Track: Engineering and Computer Science (ECS)}
		\cvitem{}{\small Master Thesis (TBA):}{}
		{\small Monocular Pose Estimation of Vehicles in Traffic based on Deep Metric Learning}


	\cvitem{2010 -- 2016}{Electrical and Computer Engineering}{\scriptsize AUTh (Greece)}
		{\small Specialization: Electronics and Computers, GPA: 7.84/10}
	\cvitem{}{\small Diploma Thesis (10/10):}{}
		{\small Development of an Autonomous Robotic Ground Vehicle with a 4WS4WD Kinematic Model and Implementation of a System for Autonomous Exploration in Unknown Environments}
\end{cvtable}
...
\begin{cvtable}[3]
\vspace{-0.25cm}
\cvitem{2019 -- 2020}{Industry 4.0 Consultant}{Kapernikov CVBA}{\small Worked on projects for computer vision based warehouse forklift localization, automated visual quality testing of industrial products, and industrial process monitoring.}
\vspace{-0.25cm}
\cvitem{2017 -- 2018}{Research Assistant}{ ITI -- CERTH}{\small
Worked on control, autonomous navigation, and subsurface mapping with a GPR-equipped tractor-trailer UGV, as part of Project BADGER (EU Horizon2020.}
\cvitem{2014 -- 2016}{Volunteer Robotics Engineer}{\small Pandora Robotics Team (AUTH)}{
Worked on  all stages of development of a state-of-the-art AMR for search-and-rescue operations. Focused mainly on sensors and actuators, control, and autonomous navigation.}
\end{cvtable}
...
\cvsection{Awards}
\begin{cvtable}
	\cvitem{2015}{2nd Best in Class Autonomy Award}{Pandora Robotics Team}{\small Robocup Rescue 2015 competition in Hefei, China}
	\cvitem{2015}{Excellence Award}{Pandora Robotics Team}{\small Awarded by the Aristotle University of Thessaloniki for the Distinction in Robocup Rescue 2015 competition}
\end{cvtable}
