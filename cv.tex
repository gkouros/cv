...
% job title/career
\cvjobtitle{Robotics Software Engineer}
...
\cvaddress{\href{https://www.google.com/maps/place/Boulevard+du+Midi+41,+1000+Bruxelles/}{Brussels, Belgium}}
% phone number
\cvphone{+30 697 284 3182}
% personal website
% email address
...
\addtofrontsidebar{
	...
	\aboutme{I am an autonomous robots specialist, experienced in search-and-rescue, utility mapping and industrial robotics. I am always busy pursuing new ways to utilize artificial intelligence and deep learning in order to create trully intelligent robots. Robots that add real value to society.}
...
\begin{cvtable}[3]
\vspace{-0.25cm}
\cvitem{2019 -- Now}{Industry 4.0 Consultant}{Kapernikov CVBA}{Worked on computer vision based forklift localization, quality testing of industrial products, and industrial operation monitoring. Also, organized a company wide knowledge-sharing workshop on ROS, Visual Odometry and Visual SLAM.}
\vspace{-0.25cm}
